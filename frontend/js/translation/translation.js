...
const translations = {
	en: {
		...
		pong_version: "Select the version of the Pong you want to play.",
		classic: "Classic",
		custom: "Custom",
		play: "Let's play!",
		...
		batarangs_colors: "Select the Batarangs' colors:",
		red_green: "Red & Green",
	...
	fr: {
		...
		tournament: "Tournoi",
		pong_version: "Sélectionnez la version du jeu auquel vous voulez jouer.",
		classic: "Classique",
		custom: "Personnalisé",
		play: "Jouer !",
		...
		batarangs_colors: "Sélectionnez les couleurs des Batarangs:",
		red_green: "Rouge & Vert",
		green_violet: "Vert & Violet",
		blue_yellow: "Bleu & Jaune",
	...
	es: {
		...
		tournament: "Torneo",
		pong_version: "Seleccione la versión del juego al que quiere jugar.",
		classic: "Clásico",
		...
		batarangs_colors: "Seleccione los colores de los Batarangs:",
		red_green: "Rojo & Verde",
		green_violet: "Verde & Violeta",
		blue_yellow: "Azul & Amarillo",
